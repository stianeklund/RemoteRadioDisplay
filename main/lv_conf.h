 ...
 */
#define LV_USE_STDLIB_MALLOC    LV_STDLIB_CLIB  /*Use standard C library (ESP-IDF malloc can use SPIRAM)*/
...
#define LV_STDARG_INCLUDE       <stdarg.h>
    ...
    #define LV_MEM_SIZE (96 * 1024U)          /*[bytes] Optimized to 96KB to save internal SRAM while maintaining performance*/
...
/* MEMORY OPTIMIZATION: Since we're using LV_STDLIB_ESP_IDF, 
 * LVGL will use ESP-IDF's malloc which can allocate in SPIRAM.
 * This saves internal SRAM by moving LVGL's memory pool to SPIRAM. */
...
#define LV_DEF_REFR_PERIOD  33      /*[ms]*/ /* Optimized to 30 FPS for better CPU efficiency */

/*Default Dot Per Inch. Used to initialize default sizes such as widgets sized, style paddings.
 *(Not so important, you can adjust it to modify default sizes and spaces)*/
#include "sdkconfig.h"
#if CONFIG_IDF_TARGET_ESP32P4
#define LV_DPI_DEF 200     /*[px/inch] P4: 1280x720 on 5" = ~293 DPI physical, 200 logical*/
#else
#define LV_DPI_DEF 130     /*[px/inch] S3: 800x480 on 5" = ~186 DPI physical*/
#endif
...
#include "sdkconfig.h"
#if CONFIG_IDF_TARGET_ESP32P4
#define LV_DRAW_BUF_STRIDE_ALIGN                64  /* P4 DMA2D requires 64-byte alignment */
...
#define LV_DRAW_LAYER_SIMPLE_BUF_SIZE    (32 * 1024)   /*[bytes]*/ /* Increased for better performance */
...
#define LV_USE_DRAW_SW 1
    ...
    #define LV_DRAW_SW_COMPLEX          1
        ...
        *Caching has LV_DRAW_SW_SHADOW_CACHE_SIZE^2 RAM cost*/
        #define LV_DRAW_SW_SHADOW_CACHE_SIZE 4  /* Enable small shadow cache for performance */
...
#define LV_USE_ASSERT_NULL          1   /*Debug: Check for NULL pointers*/
#define LV_USE_ASSERT_MALLOC        1   /*Debug: Check malloc returns*/
#define LV_USE_ASSERT_STYLE         0   /*Disabled for production performance - style checks removed*/
#define LV_USE_ASSERT_MEM_INTEGRITY 0   /*Check the integrity of `lv_mem` after critical operations. (Slow)*/
#define LV_USE_ASSERT_OBJ           1   /*Debug: Check object validity*/
...
#define LV_OBJ_STYLE_CACHE      1  /* Enabled for faster style lookups */
...
#if CONFIG_IDF_TARGET_ESP32P4
#define LV_ATTRIBUTE_MEM_ALIGN_SIZE 64  /* P4 PPA/DMA2D requires 64-byte alignment */
#else
...
#define LV_ATTRIBUTE_LARGE_CONST __attribute__((section(".flash.rodata")))  /* Place in flash to save SRAM */
...
#define LV_USE_THEME_DEFAULT 1
    ...
    #define LV_THEME_DEFAULT_TRANSITION_TIME 50  /* Reduced for snappier UI */
